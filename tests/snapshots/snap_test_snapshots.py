...
snapshots["test_validate_success_with_files 2"] = {"message": None, "result": True}

snapshots["test_validate_success_without_files 1"] = 200

snapshots["test_validate_success_without_files 2"] = {"message": None, "result": True}
